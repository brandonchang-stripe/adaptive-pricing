...
export const soundBoard = {
  ...
  clickDown: new Howl({ src: "./sfx/click_02.mp3", volume: 0.6 }),
  clickUp: new Howl({ src: "./sfx/click_01.mp3", volume: 0.6 }),
  clickDisabled: new Howl({ src: "./sfx/tock_01.mp3", volume: 0.3 }),
